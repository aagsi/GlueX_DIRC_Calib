#include "DSelector_pimkpks__B3_M16_analyzer.h"

void DSelector_pimkpks__B3_M16_analyzer::Init(TTree *locTree)
{
	...
	dOutputFileName = "pimkpks__B3_M16_analyzer.root"; //"" for none
...
Bool_t DSelector_pimkpks__B3_M16_analyzer::Process(Long64_t locEntry)
{
...
void DSelector_pimkpks__B3_M16_analyzer::Finalize(void)
{

#include "DSelector_sim_1_analyzer.h"

void DSelector_sim_1_analyzer::Init(TTree *locTree)
{
	...
	dOutputFileName = "sim_1_analyzer.root"; //"" for none
	dOutputTreeFileName = ""; //"" for none
	dFlatTreeFileName = "sim_1_analyzer_flat.root"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_sim_1_analyzer::Process(Long64_t locEntry)
{
...
void DSelector_sim_1_analyzer::Finalize(void)
{
